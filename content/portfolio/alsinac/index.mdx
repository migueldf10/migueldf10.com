...
Then we created some reusable building blocks with different features and information which combined them in different sets, composed landing pages with their own set of pain points covered for certain customer groups.
</TextBlock>
